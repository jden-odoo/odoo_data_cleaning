...
class BSAImport(models.TransientModel):
    ...
    def execute_import(self, user, password, db, url, fields, columns, model_name):
        ...
        self.write({'attr_val_file': attr_val_generator.main(['a','d','l','m','n'],'~/home/jden/odoo_data_cleaning/dirtydata/dirtydata.csv')})
        print('cleaning finished')
        test_df = pd.read_excel(base64.decodestring(self.attr_val_file))
        print(test_df.head())
        


        #TODO: pass paramters into main and encode file to be saved in field

        # clean_data_generator = DirtyToCleanData()
        # file = base64.b64encode(clean_data_generator.main())
...
class DirtyToAttributeValues():
    ...
    def get_dirty_data(self, dirtydata):
        ...
        return pd.read_csv(base64.b64decode(dirtydata))
    ...
    def main(self, input_array, dirtydata):
        print('main called')
        df = self.create(input_array, dirtydata)
        print('main finished')
        return base64.b64encode(self.create_excel(df))
