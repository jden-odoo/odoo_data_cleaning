...
def output_clean_data(item_dict,outHeader,id_dict):
    f = open('./outputdata2.csv','w')
    writer = csv.writer(f)
...
# main(sys.argv[1],sys.argv[2].split(','),sys.argv[3],sys.argvs[4],sys.argv[5])
main('dirty2.csv',['a','c','d','l','m','n','q'],'a', 'i','j')